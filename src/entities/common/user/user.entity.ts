...
export class Users extends DatetimeService {
  ...
  @Column({ name: 'password', nullable: true, select: false }) password: string;
  ...
  @Column({ nullable: true, name: 'mobile_no' }) mobileNo: string;
  ...
  @Column({ nullable: true, name: 'gender' }) gender: string;
  ...
  @ManyToOne(type => Companies, comp => comp.id, { cascade: true }) @JoinColumn({ name: 'company_id' }) companies: Companies;
