import { Controller, HttpException, HttpStatus, Get, UseGuards, Res, Req, Query, Param, Post, UsePipes, ValidationPipe, Body, Put, Delete, Headers } from '@nestjs/common';
...
@ApiTags('Settings: Approve Status')
@Controller('approveStatus')
export class ApproveStatusController {
  constructor(
    private readonly mainServices: ApproveStatusService,
